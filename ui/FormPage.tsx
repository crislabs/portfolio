'use client';
import { portfolioCreatePage0, portfolioCreatePage0gq } from '@/lib/page/page0/createPage0';
import {
  portfolioUpdateImagePage0,
  portfolioUpdatePage0,
} from '@/lib/page/page0/updatePage0';
...
export function FormPage(props: Props) {
  ...
  const {
    mutate: createPetPage0,
    isLoading,
    isError,
    error,
  } = useMutation({
    mutationFn: async (input: CreatePage) => await portfolioCreatePage0gq(input),

    
    onSuccess: async (data) => {
      console.log('data', data);
      queryClient.setQueryData<Page[]>(
        ['portfolio-get-pages0', data.parentId],
